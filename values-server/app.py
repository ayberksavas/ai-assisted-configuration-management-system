...
def get_value(app_name):
    ...
    if not os.path.exists(file_path):
        abort(404, description="Value file not found")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Simple Value Server")
    
    # Define the arguments
    parser.add_argument("--schema-dir", type=str, default="/data/values", help="Directory containing JSON values")
    parser.add_argument("--listen", type=str, default="0.0.0.0:5002", help="host:port to listen on")
